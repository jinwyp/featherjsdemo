...
var PageId = 'pfbe6997c6c75444f950cee06e73459ea'
var PageUrl = 'articlelist_1.html'
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u27').replace(/\[\[label\]\]/g, "文章标题"));
...
InsertBeforeEnd(u27based, "<div class='anncontent'><span class='annfieldname'>Description:</span> 点击 结果列表中的 文章标题 列 可以进入到相应文章页面 例如 http://www.autobild.com.cn/news/201006-715830.html<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u33').replace(/\[\[label\]\]/g, "编辑"));
...
InsertBeforeEnd(u33based, "<div class='anncontent'><span class='annfieldname'>Description:</span> 点击 结果列表中的 编辑 列 进入到修改相应视频（该node）的信息 例如 http://editor.autobild.com.cn/node/635676/edit<BR><BR></div>");
