...
var PageName = 'single-video';
var PageId = 'p216336b9ad154a9d941d59464ebdb822'
var PageUrl = 'single-video.html'
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u57').replace(/\[\[label\]\]/g, "SingleVideoPage:Video title"));
...
InsertBeforeEnd(u57based, "<div class='anncontent'><span class='annfieldname'>Description:</span> Video title.18个字标题.视频尺寸:4:3-466*350<BR><BR></div><div class='anncontent'><span class='annfieldname'>Stability:</span> this field Belong to video 视频的一个字段属性<BR><BR></div><div class='anncontent'><span class='annfieldname'>Target Release:</span> pic size:4:3-466*350<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u56').replace(/\[\[label\]\]/g, "SingleVideoPage:Related Videos"));
...
InsertBeforeEnd(u56based, "<div class='anncontent'><span class='annfieldname'>Description:</span> show Related Videos using related car model and tags. 逻辑:第一逻辑:根据该视频的相关的车型调出该车系其他的视频,第二逻辑:但第一逻辑数量不够时,通过视频的关键词调出相关的视频,需要排除自己.显示:按照发布时间排序,10个字标题.<BR><BR></div><div class='anncontent'><span class='annfieldname'>Target Release:</span> pic size:4:3-120*90<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u59').replace(/\[\[label\]\]/g, "SingleVideoPage:Video play count"));
...
InsertBeforeEnd(u59based, "<div class='anncontent'><span class='annfieldname'>Description:</span> show how many times played.视频播放次数.<BR><BR></div><div class='anncontent'><span class='annfieldname'>Stability:</span> this field Belong to video 视频的一个字段属性<BR><BR></div><div class='anncontent'><span class='annfieldname'>Target Release:</span> pic size:4:3-466*350<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u58').replace(/\[\[label\]\]/g, "SingleVideoPage:Video description"));
...
InsertBeforeEnd(u58based, "<div class='anncontent'><span class='annfieldname'>Description:</span> Video description 视频介绍<BR><BR></div><div class='anncontent'><span class='annfieldname'>Stability:</span> this field Belong to video 视频的一个字段属性<BR><BR></div>");
