...
var PageId = 'p92a1618c51494cdf84404bfa3b500a9b'
var PageUrl = 'commentslist_1.html'
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u16').replace(/\[\[label\]\]/g, "文章标题"));
...
InsertBeforeEnd(u16based, "<div class='anncontent'><span class='annfieldname'>Description:</span> 点击 结果列表中的 文章标题 列 可以进入到相应文章页面 例如 http://www.autobild.com.cn/news/201006-715830.html<BR><BR></div>");
