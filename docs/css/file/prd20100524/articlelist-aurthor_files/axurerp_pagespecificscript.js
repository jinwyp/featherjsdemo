...
var PageName = 'articlelist-aurthor';
var PageId = 'p1e31358082484b808d267e8f9a98a604'
var PageUrl = 'articlelist-aurthor.html'
document.title = 'articlelist-aurthor';
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u51').replace(/\[\[label\]\]/g, "channelSideBar:lastest feature aritcle"));
...
InsertBeforeEnd(u51based, "<div class='anncontent'><span class='annfieldname'>Description:</span> 显示最新的“专题”的所有文章。<BR><BR></div><div class='anncontent'><span class='annfieldname'>Target Release:</span> pic size:4:3-200*150<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u36').replace(/\[\[label\]\]/g, "channelSideBar:Hot models"));
...
InsertBeforeEnd(u36based, "<div class='anncontent'><span class='annfieldname'>Description:</span> NodeQueueID 84,85,86,88,89,90 与首页的上部推荐的中小型车 中高级车相同<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u35').replace(/\[\[label\]\]/g, "channelSideBar:promoted testing articles"));
...
InsertBeforeEnd(u35based, "<div class='anncontent'><span class='annfieldname'>Description:</span> NodeQueueID 65 更多链接到评测频道<BR><BR></div><div class='anncontent'><span class='annfieldname'>Target Release:</span> pic size:16:9-200*113<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u34').replace(/\[\[label\]\]/g, "channelSideBar:Lastest 3D modle"));
...
InsertBeforeEnd(u34based, "<div class='anncontent'><span class='annfieldname'>Description:</span> 最新的3D车型 更多链接到http://www.autobild.com.cn/search-model?h3d=1<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u33').replace(/\[\[label\]\]/g, "channelSideBar:promoted articles"));
...
InsertBeforeEnd(u33based, "<div class='anncontent'><span class='annfieldname'>Description:</span> NodeQueueID 62 更多链接到新闻频道<BR><BR></div><div class='anncontent'><span class='annfieldname'>Target Release:</span> pic size:16:9-200*113<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u50').replace(/\[\[label\]\]/g, "channelSideBar:hot bbs post"));
...
InsertBeforeEnd(u50based, "<div class='anncontent'><span class='annfieldname'>Description:</span> 逻辑:显示28天内帖子点击量排序.点击量最高的显示在最上面.<BR><BR></div><div class='anncontent'><span class='annfieldname'>Target Release:</span> pic size:4:3-200*150<BR><BR></div>");
...
eval(annwindow.replace(/\[\[id\]\]/g, 'u37').replace(/\[\[label\]\]/g, "channelSideBar:promoted videos"));
...
InsertBeforeEnd(u37based, "<div class='anncontent'><span class='annfieldname'>Description:</span> NodeQueueID 73 和视频首页焦点图 相同 更多链接到视频频道<BR><BR></div><div class='anncontent'><span class='annfieldname'>Target Release:</span> pic size:4:3-200*150<BR><BR></div>");
