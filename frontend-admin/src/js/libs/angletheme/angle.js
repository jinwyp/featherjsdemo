...
!function (e, t, o, n) {
            ...
            e.fullCalendar({
                ...
                drop           : function (t, a) {
                    ...
                    if (i) {
                        ...
                        l.start = t,
                            l.allDay = a,
                            l.backgroundColor = r.css("background-color"),
                            l.borderColor = r.css("border-color"),
                            e.fullCalendar("renderEvent", l, !0),
                        n.is(":checked") && r.remove()
                    }
                },
            ...
            r.is(":visible") && (r.on("click", function (e) {
                e.preventDefault(),
                    screenfull.enabled ? (screenfull.toggle(),
                        n(r)) : console.log("Fullscreen not enabled")
            }),
    ...
    function (e, t, o, n) {
        o(function () {
            if (o.fn.cropper) {
                var n   = o(".img-container > img")
                    ...
                    crop        : function (e) {
                        a.val(Math.round(e.x)),
                            ...
                            l.val(Math.round(e.width)),
                            s.val(Math.round(e.rotate))
                    }
                };
                n.on({
                    ...
                    o(t.body).on("click", "[data-method]", function () {
                        ...
                        if (n.data("cropper") && a.method) {
                            if (a = o.extend({}, a),
                                "undefined" != typeof a.target && (e = o(a.target),
                            ...
                            if (t = n.cropper(a.method, a.option),
                                "getCroppedCanvas" === a.method && o("#getCroppedCanvasModal").modal().find(".modal-body").html(t),
                                o.isPlainObject(t) && e)
                                try {
                ...
                f ? u.change(function () {
                    var e, t = this.files;
                    n.data("cropper") && t && t.length && (e = t[0],
                        /^image\/\w+$/.test(e.type) ? (d = f.createObjectURL(e),
                            n.one("built.cropper", function () {
                                f.revokeObjectURL(d)
                    ...
                    o(".docs-options :checkbox").on("change", function () {
                        var e = o(this);
                        n.data("cropper") && (c[e.val()] = e.prop("checked"),
                            n.cropper("destroy").cropper(c))
                    }),
                    o('[data-toggle="tooltip"]').tooltip()
            }
        })
    ...
    function (e, t, o, n) {
        ...
        o(function () {
            o("[data-load-css]").on("click", function (e) {
                ...
                r ? (n = a(r),
                n || o.error("Error creating stylesheet link element.")) : o.error("No stylesheet location defined.")
            })
        })
    }(window, document, window.jQuery),
    function (e, t, o, n) {
            ...
            if (o.fn.localize) {
                var n   = o.localStorage.get(l) || a
                    ...
                    callback   : function (e, t) {
                        o.localStorage.set(l, n),
                            t(e)
                    }
                };
                e(s),
                    o("[data-set-lang]").on("click", function () {
                        n = o(this).data("setLang"),
                        n && (s.language = n,
                            e(s),
                            t(o(this)))
                    })
    ...
    function (e, t, o) {
        var n   = {}
            ...
            this.options.status && (this.element.addClass("alert alert-" + this.options.status),
                ...
                a[this.uuid] = this,
            n[this.options.pos] || (n[this.options.pos] = e('<div class="uk-notify uk-notify-' + this.options.pos + '"></div>').appendTo("body").on("click", ".uk-notify-message", function () {
        ...
        return e.extend(l.prototype, {
            ...
            close         : function (e) {
                var t   = this
                    , o = function () {
                    t.element.remove(),
                    n[t.options.pos].children().length || n[t.options.pos].hide(),
                        delete a[t.uuid]
                };
    ...
    function (e, t, o) {
        ...
        e(l).each(function () {
            var t   = e(this)
                ...
                , c = t.children("em")
                , d = o.attr("id");
            l.length || (l = o.children(".panel-heading").nextAll().wrapAll("<div/>").parent().addClass("panel-wrapper"),
                s = {}),
                l.collapse(s).on("hide.bs.collapse", function () {
                    a(c),
                        r(d, "hide"),
                        l.prev(".panel-heading").addClass("panel-heading-collapsed")
                }).on("show.bs.collapse", function () {
                    n(c),
                        r(d, "show"),
                        l.prev(".panel-heading").removeClass("panel-heading-collapsed")
                });
            var u = i(d);
    ...
    function (e, t, o) {
        ...
        function n(t, o) {
            ...
            n || (n = {}),
                n[this.id] = e(this).sortable("toArray"),
            n && e.localStorage.set(i, n)
        }
    ...
    function (e, t, o, n) {
        o(function () {
            if ("undefined" != typeof Rickshaw) {
                for (var e = [[], [], []], o = new Rickshaw.Fixtures.RandomData(150), n = 0; n < 150; n++)
                    o.addData(e);
                var a   = [{
                    color : "#c05020",
                    data  : e[0],
    ...
    function (e, t, o, n) {
        ...
        o(function () {
            ...
            u() || n.addClass("active").children(".collapse").collapse("show"),
    ...
    function (e, t, o, n) {
        o(function () {
            function t() {
                ...
                n.type = n.type || "bar",
                    n.disableHiddenCheck = !0,
                    t.sparkline(a, n),
                n.resize && o(e).resize(function () {
                    t.sparkline(a, n)
                })
            }
            ...
            toggle = new StateToggler,
                o("[data-toggle-state]").on("click", function (a) {
                    ...
                    var r   = o(this)
                        ...
                        , c = l ? o(l) : t;
                    i && (c.hasClass(i) ? (c.removeClass(i),
                    s || toggle.removeState(i)) : (c.addClass(i),
                    s || toggle.addState(i))),
                        o(e).resize()
                })
        }),
            e.StateToggler = function () {
                ...
                return {
                    addState     : function (n) {
                        ...
                        a = a ? t.addWord(a, n) : n,
                            o.localStorage.set(e, a)
                    },
                    removeState  : function (n) {
                        var a = o.localStorage.get(e);
                        a && (a = t.removeWord(a, n),
                            o.localStorage.set(e, a))
                    },
    ...
    function (e, t, o) {
        ...
        e.support.transition = function () {
                    ...
                    try {
                        for (d = document.styleSheets,
                            ...
                            for (n = d[a],
                                     ...
                                     t = r = 0,
                                     s = n.cssRules.length; r < s; t = ++r)
                                n.cssRules[t].type === CSSRule.STYLE_RULE && e.test(n.cssRules[t].selectorText) && o.unshift(t);
                            for (i = 0,
                                     c = o.length; i < c; i++)
                                n.deleteRule(o[i])
                        }
            ...
            e.Utils.isInView = function (t, o) {
                ...
                c + n.height() >= i && c - o.topoffset <= i + a.height() && s + n.width() >= r && s - o.leftoffset <= r + a.width()
            }
            ,
            ...
            e.langdirection = "rtl" == n.attr("dir") ? "right" : "left",
            e(function () {
